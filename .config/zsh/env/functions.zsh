...
grc-refresh() {
  ...
  # Prevent grc aliases from overriding zsh completions.
    ...
    {  
      ...
      echo ""
      echo "# This file is autogenerated from 'grc-refresh'"
      echo "# Manual edits will most likely be lost"
      echo ""
      echo "# Colorize output from commands run via sudo"
      echo 'if [ "${+commands[grc]}" = "1" ]; then'
    ...
    {
      echo '  alias colourify="grc -es --colour=auto"'
      echo "fi"
    } >> "${ZDOTDIR}/env/grc.zsh"
