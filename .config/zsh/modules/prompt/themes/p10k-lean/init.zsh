source "${ZDOTDIR}/modules/prompt/themes/powerlevel10k/init.zsh"

# Generated by Powerlevel10k configuration wizard on 2020-01-09 at 14:25 CST.
...
() {
  ...
  typeset -g POWERLEVEL9K_DIR_FOREGROUND=06
  ...
  typeset -g POWERLEVEL9K_DIR_ANCHOR_FOREGROUND=06
  ...
  function my_git_formatter() {
    ...
    if (( $1 )); then
      ...
      local      clean='%203F'   # green foreground
